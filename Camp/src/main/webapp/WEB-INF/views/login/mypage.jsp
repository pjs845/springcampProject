...
<style>
	...
	<body class="profile-page">
		...
		<div class="page-header header-filter" data-parallax="true" style="background-image:url(/img/17.png)"></div>
			...
			<div class="profile-content">
				<div class="container">
						...
						<div class="col-md-6 ml-auto mr-auto">
						   <div class="profile">
								...
								<div class="name">
									...
									<h6>PHONE_NUMBER : ${member.phone}</h6>
									<h6>EMAIL_ADDRESS : ${member.email}</h6>
					...
					<div class="description text-center">
						<p>소개글:_캠핑을 좋아하는 나그네:)</p>
						   
			<div class="container">
					<ul class="navbar-nav ml-auto">
						<li class="dropdown nav-item">
						  <a href="updateinfo" class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false">
							  <i class="material-icons">apps</i> 회원정보수정
						  </a>
						  <div class="dropdown-menu dropdown-with-icons">
							  
							  
							<!-- <a href="../login/updateinfo" class="dropdown-item">
								<i class="material-icons">layers</i> 정보수정
							</a> -->
							
							<a href="../login/deleteAcount?email=${member.email}" class="dropdown-item">
								<i class="material-icons">content_paste</i> 회원탈퇴
							</a>
							 
							<a href="../login/checkpassword?email=${member.email}" class="dropdown-item">
								<i class="material-icons">lock</i> 비밀번호변경
							  </a>  
						  </div>
			  ...
			  <div class="tab-content tab-space">
				<div class="tab-pane active text-center gallery" id="studio">
					  <div class="row">
						  <div class="col-md-3 ml-auto">
							  <img src="/img/9.jpg" class="rounded">
							  <img src="/img/6.png" class="rounded">
						  </div>
						  <div class="col-md-3 mr-auto">
							  <img src="/img/2.png" class="rounded">
							  <img src="/img/pp1.PNG" class="rounded">
						  </div>
					  </div>
				  </div>
				<div class="tab-pane text-center gallery" id="works">
					  <div class="row">
						  <div class="col-md-3 ml-auto">
						  <img src="/img/11.jpg" class="rounded">
							<img src="/img/pp1.png" class="rounded">
				...
				<div class="tab-pane text-center gallery" id="favorite">
					  <div class="row">
						  <div class="col-md-3 ml-auto">
							<img src="/img/12.jpg" class="rounded">
		...
		<footer class="footer text-center ">
			<p> released by <a href="#" target="_blank"></a>_com.Team 4</p>
		</footer>
