...
<head>
    ...
    <script type="text/javascript"> 	
    	...
    	window.onload = function() {
			...
			for (const camp of {{addr|safe}}){
    			// JSON 형식으로 리스트에 추가 실시
    			var jsonObject = {"name":String(camp["name"]), "addr":String(camp["addr"]), "img":String(camp["img"])};
                //var jsonObject = {"name":String(key)};
    			console.log(camp["addr1"])
				var markerinfo = [camp["addr1"],camp["name"]]
				
    		}
			
			searchAddressToCoordinate(markerinfo);
    		console.log("");
